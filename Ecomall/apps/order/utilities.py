...
def checkout(request, first_name, last_name, email, address, postal_code, city, phone, amount):
    order = Order.objects.create(first_name=first_name, last_name=last_name, email=email, address=address, postal_code=postal_code, city=city, phone=phone, paid_amount=amount)
